                        ...
                        <el-form :model="resinfo" :rules="rules" ref="ruleForm" label-width="80px" class="demo-ruleForm">
                            <el-form-item label="客房类型" prop="type" required @click="resolveData">
                                <el-select v-model="resinfo.type" placeholder="请选择" :disabled="lockCondition">
                                    <el-option v-for="item in roomtype" :key="item.id" :label="item.typeName"
                                        :value="item.id">
                                    </el-option>
                                </el-select>
                            </el-form-item>
                            ...
                            <el-form-item label="入住时间" required>
                                <el-col :span="24" class="mb-1">
                                    <el-form-item prop="indate">
                                        <el-date-picker :disabled="lockCondition" type="datetime" placeholder="入住日期"
                                            :picker-options="options" v-model="resinfo.indate" style="width: 100%">
                                        </el-date-picker>
                                    </el-form-item>
                                </el-col>
                                ...
                                <el-col :span="24">
                                    <el-form-item prop="leavedate">
                                        <el-date-picker :disabled="lockCondition" type="datetime" placeholder="离店日期"
                                            :picker-options="options" v-model="resinfo.leavedate" style="width: 100%">
                                        </el-date-picker>
                                    </el-form-item>
                                </el-col>
                            </el-form-item>
                            ...
                            <el-form-item>
                                <el-button :type="searchBtnType" @click="checkroom" :disabled="checkBtnDis">
                                    <i :class="searchicon" style="font-size: 18px"></i>
                                    查询可用房间
                                </el-button>
                            </el-form-item>
                            ...
                            <el-form-item label="房间号码" prop="id" required>
                                <el-select v-model="resinfo.id" placeholder="请先选择房间号" :disabled="isNotSelect">
                                    <el-option v-for="item in roomnumber" :key="item.id" :label="item.number"
                                        :value="item.id">
                                    </el-option>
                                </el-select>
                            </el-form-item>
                            ...
                            <el-form-item label="住店人数" prop="num" required>
                                <el-input-number v-model="resinfo.num" :min="1" :max="maxp" label="请输入"
                                    :disabled="isNotSelect"></el-input-number>
                            ...
                            <el-form-item>
                                ...
                                <br />
                                <el-button @click="resetForm('ruleForm')" type="warning" style="font-size: 22px">
                                    重置选项
                                </el-button>
                            </el-form-item>
                        </el-form>
