			...
			<el-main class="section">
				...
				<el-card class="box-card pb-1" style="opacity: 0.95;">
					<div class="text item" style="margin-bottom: 20px;">
						<el-row>
							<el-col :span="16">
								<p class="text-left"><i class="el-icon-location-outline"></i>五星级酒店</p>
							</el-col>
						</el-row>
								...
								<el-col :span="12">
									<el-form-item label="入住时间">
										<el-date-picker type="datetime" placeholder="选择日期" v-model="form.indate"
											:picker-options="options" style="width: 100%;"></el-date-picker>
									</el-form-item>
								</el-col>
								<el-col :span="12">
				...
				<el-row>
					<el-card class="mb-1 ml-1 mr-1">
						<div class="text item">
							<el-button type="primary" style="font-size: 16px;" class="btn-block" @click="searchBtn">
								查询空余房间</el-button>
						</div>
					</el-card>
					<el-col :span="24" v-for="(tp, index) in listdata" :key="index" style="padding: 0 15px 0 15px">
